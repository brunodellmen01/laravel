    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('scale_teams[people_id]', $people_id, null, ['required', 'class' => 'form-control select ' . ($errors->has('scale_teams.people_id') ? ' is-invalid' : null), 'placeholder' => trans('generic.select')]) }}
                <small class="invalid-feedback">
