    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{ Form::number('contact[number]', null, ['class' => 'form-control ' . ($errors->has('contact.number') ? ' is-invalid' : null), 'autocomplete' => 'off', 'placeholder' => trans('people.number'), 'maxlength' => '10', 'minlength' => '3']) }}
                <small class="invalid-feedback">
